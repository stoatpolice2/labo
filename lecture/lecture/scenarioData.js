...
const scenarioData = {
    ...
    chapter1: [
        ...
        {
            speaker: "猪狩進",
            text: "実は、僕たちが今こうして話しているこのゲームも、すべて『HTML・CSS・JavaScript』の手書きだけで作られているんだよ！",
            img: "images/susumu_normal.png"
        },
        {
            speaker: "猪狩進",
    ...
    chapter3: [
        ...
        {
            speaker: "猪狩進",
            text: "ここでクイズ！HTMLと同じフォルダの中にある『images』というフォルダ内の『hero.jpg』を表示したい時、src属性（パス）はどう書くのが正解だと思う？",
            hint: "ヒント：『フォルダ名』と『ファイル名』をスラッシュ『/』でつないで道順を教えてあげるんだ！『imagesフォルダの中にある hero.jpg』という順番で書いてみよう！",
            img: "images/susumu_normal.png",
            choices: [
                { text: "A: src=\"images/hero.jpg\"", targetIndex: "c3_correct" },
                { text: "B: src=\"hero.jpg\"", targetIndex: "c3_wrong" },
                { text: "C: src=\"folder/images/hero.jpg\"", targetIndex: "c3_wrong" }
            ]
        }
    ],
    ...
    c3_wrong: [
        {
            speaker: "猪狩進",
            text: "う〜ん、惜しい！正解は『A: src=\"images/hero.jpg\"』なんだ。『フォルダ名/ファイル名』の順番で道順を教えてあげるんだよ。",
            img: "images/susumu_laugh.png",
            nextChapter: "c3_end"
        }
    ],
    c3_end: [
        ...
        {
            speaker: "猪狩進",
            text: "画像タグの詳しい書き方や『ひとつ上のフォルダに戻る方法（../）』は、僕のノートにまとめておいたよ。一緒に見にいこう！",
            img: "images/susumu_smile.png",
            link: "chapter03.html"
        }
    ],
